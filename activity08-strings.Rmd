...
billboard <- readr::read_tsv("data/billboard_songs.txt")
...
**Response**: 10 titles above spent the longest on the charts
...
```{r most_featued_artist}

artist_credentials <- bb %>% 
  pull(artist)
